...
package vn.cybersoft.obs.android.controllers;
 ...
 *
 */
public class OBSDialogController {
/*    private final Context mContext;
    ...
    public OBSDialogController(Context context, DialogInterface di, Window window) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
    ...
    *//**
    ...
    public static class AlertParams {
        ...
        *//**
        ...
        public void apply(OBSDialogController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final OBSDialogController dialog) {
